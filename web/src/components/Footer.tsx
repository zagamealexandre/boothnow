        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">BoothNow</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              On-demand soundproof micro-workspaces in convenience stores. 
              Perfect for remote professionals who need a quiet, productive workspace.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-3 text-gray-400">
                <Mail className="w-4 h-4" />
                <span>hello@boothnow.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 BoothNow. All rights reserved.
            </p>
